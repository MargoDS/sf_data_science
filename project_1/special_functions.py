...
hh_b = pd.read_csv('dst-3.0_16_1_hh_database.csv', sep=';')
hh_b['Должность'] = hh_b['Ищет работу на должность:'].apply(get_profession)

print(hh_b['Должность'].value_counts()[:100])
